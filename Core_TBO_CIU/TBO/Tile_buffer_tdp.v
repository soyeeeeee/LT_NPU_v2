...
module Tile_buffer_tdp (
    ...
    input [7:0] addra,
    input [31:0] dina,
    output [31:0] douta, // Port A 讀取資料輸出
    ...
    xpm_memory_tdpram #(
        ...
        .BYTE_WRITE_WIDTH_B(32),         // Port B 寫入寬度 (不使用 Byte Enable)
        ...
        .MESSAGE_CONTROL(0),
        .READ_DATA_WIDTH_A(32),          // Port A 讀取寬度
        ...
        .WRITE_DATA_WIDTH_B(32),         // Port B 寫入寬度
