...
(* DONT_TOUCH = "TRUE" *)
module Prep_buffer_sdp (
    ///// Port A (Write Only: 64-bit, 2 x 32-bit INT8 RGB pixels) /////
    input clka,
    input ena,
    input wea,
    input [6:0] addra,
    ...
    ///// Port B (Read Only: 32-bit, 1 x INT8 RGB pixel) /////
    input clkb,
    input enb,
    ...
    xpm_memory_sdpram #(
        ...
        .MEMORY_SIZE(8192),            // 總容量 bits = 128 * 64 = 8,192
        .MESSAGE_CONTROL(0),
        .READ_DATA_WIDTH_B(32),         // Port B 讀取寬度
        .READ_LATENCY_B(2),             // Port B 讀取延遲 (含外部 reg)
        .USE_MEM_INIT(0),
        .WAKEUP_TIME("disable_sleep"),
        .WRITE_DATA_WIDTH_A(64),       // Port A 寫入寬度對應 INT8 版 dina
